param(
    ...
    [string]$ManifestPath = (Join-Path $PSScriptRoot "report_light_dataset.json"),
...
$runDir = Join-Path $OutputBaseDir "report_light_dataset_$timestamp"
$logPath = Join-Path $runDir "runner.log"

New-Item -ItemType Directory -Path $runDir -Force | Out-Null

Write-Host "Starting light report dataset run"
